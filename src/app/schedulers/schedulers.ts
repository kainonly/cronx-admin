...
import { SchedulersApi } from '@shared/apis/schedulers-api';
...
export class Schedulers implements OnInit {
  global = inject(Global);
  schedulers = inject(SchedulersApi);
  ...
  m = this.global.setModel('schedulers', this.schedulers, {
    q: ''
  });
